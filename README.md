...
- **Language**: Python  
- **Code**: Simulations will be written in open-access Python code  
- **Sharing**: All code and parameter tables will be openly shared via GitHub  
- **Reproducibility**: Clear documentation will be provided to ensure reproducibility and potential collaboration  
...
- Bauri, M. (2019) ‘Notes from the field: Circulating vaccine-derived poliovirus type 1 and outbreak response — Papua New Guinea, 2018’, *MMWR. Morbidity and Mortality Weekly Report*, [online] 68. doi: https://doi.org/10.15585/mmwr.mm6805a6.  
- Bieb, S., Reza, S., Duncan, R., Hossain, M. and Clements, C.J. (2017) *A review of immunization services in Papua New Guinea, 2017*. [online] Available at: https://www.cabidigitallibrary.org/doi/pdf/10.5555/20193459426 [Accessed 27 Jul. 2025].  
- Harker, R. (2024) *Childhood immunisation statistics*. [online] Available at: https://researchbriefings.files.parliament.uk/documents/CBP-8556/CBP-8556.pdf [Accessed 27 Jul. 2025].  
- Immunization Data (2024) *WHO immunization data portal - detail page*. [online] Available at: https://immunizationdata.who.int/global/wiise-detail-page/measles-vaccination-coverage?CODE=PNG&ANTIGEN=&YEAR= [Accessed 27 Jul. 2025].  
- Jglobalbiosecurity.com (2025) ‘View of disinfection measures and control of SARS-CoV-2 transmission’, *Jglobalbiosecurity.com*, [online] Available at: https://jglobalbiosecurity.com/index.php/up-j-gb/article/view/64/160 [Accessed 27 Jul. 2025].  
- Nations, U. (2023) *Perception of the importance of vaccines for children declines in Papua New Guinea | Nações Unidas*. [online] United Nations. Available at: https://www.un.org/pt/information-center-pacific-unic/interview-dr-satish-gupta-dr-satish-gupta-chief-health-programme [Accessed 27 Jul. 2025].  
- Ochmann, S., Roser, M., Dattani, S. and Spooner, F. (2017) *Polio*. [online] Our World in Data. Available at: https://ourworldindata.org/polio [Accessed 27 Jul. 2025].  
- Polioeradication.org (2024) *GPEI - Vaccine derived poliovirus count*. [online] Available at: https://polioeradication.org/circulating-vaccine-derived-poliovirus-count/ [Accessed 27 Jul. 2025].  
...
- World Health Organization (2025) *Poliomyelitis*. [online] Available at: https://www.who.int/news-room/fact-sheets/detail/poliomyelitis [Accessed 27 Jul. 2025].  
