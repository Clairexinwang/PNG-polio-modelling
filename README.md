...
Health system inequities, notably evident in rural, under-resourced settings like PNG, are the primary contributors to uneven vaccine access, delivery systems that lack integration and consistency across regions, and delayed outbreak detection. These collectively amplify transmission risk in already vulnerable populations, including individuals residing in rural communities and children in remote settings. Structural limitations compromise the efficacy of immunisation strategies. Thus, the need for models and interventions that are both epidemiologically robust and operationally grounded is critical.
